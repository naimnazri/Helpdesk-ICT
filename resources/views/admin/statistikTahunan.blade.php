                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table>
                            <tr>
                                <td>
                                <form method="POST" {{-- action="{{url('tahunan')}}" --}} >
                                    @csrf
                                    ...
                                    <div class="form-group text-center" >
                                       ...
                                       {{--  <a href="{{ url('statistikTahunan/pdf') }}" target="_blank" class="btn btn-danger">Convert into PDF</a> --}}
                                    </div>
                                </form>
                                </td>
                            </tr>
                        ...
                        <br><br>
                        <div class="ajax1">
                            {{-- <h5>Statistik Helpdesk ICT Tahunan</h5>
