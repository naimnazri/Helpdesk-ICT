                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <div class="form-check form-check-inline">
                              ...
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="idlevel" id="idlevel" value="8" required>
                                <label class="form-check-label" for="inlineRadio2">Pentadbir Sistem</label>
                              </div>
                              @endif
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" minlength="9" maxlength="13" name="no_ofis" class="form-control" id="notel" placeholder=" Masukkan No Pejabat" required>
                        <span class="text-danger">Sila masukkan nombor tanpa '-'</span>
                    </div>
                    <div class="form-group">
                        <label for="notel">No Telefon</label>
                        <input type="text" minlength="10" maxlength="13" name="notel" class="form-control" id="notel" placeholder=" Masukkan No Telefon" required>
                        <span class="text-danger">Sila masukkan nombor tanpa '-'</span>
                    </div>
                    <div class="form-group">
