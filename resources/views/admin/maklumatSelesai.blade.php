        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                @if($aduan->idstatus == 4 )
                <li class="breadcrumb-item"><a href="{{url('/aduanproses')}}">Aduan Dalam Tindakan</a></li>
                @elseif($aduan->idstatus == 9)
                <li class="breadcrumb-item"><a href="{{url('/aduanpembekal')}}">Aduan Tindakan Pembekal</a></li>
                @elseif($aduan->idstatus == 3)
                <li class="breadcrumb-item"><a href="{{url('/aduanselesai')}}">Aduan Selesai</a></li>
                @elseif($aduan->idstatus == 10)
                <li class="breadcrumb-item"><a href="{{url('/aduantolak')}}">Aduan Tolak</a></li>
                @endif
