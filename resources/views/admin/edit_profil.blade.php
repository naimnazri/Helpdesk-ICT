      ...
      <div class="row">
        <div class="col-12">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" method="POST" action="{{ url('a_storeProfil/'.$profil->idpengguna)}}">
                    @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="no_ofis" class="form-control" id="notel" value="{{$profil->no_ofis}}" required>
                    </div>
                    <div class="form-group">
                        <label for="notel">No Telefon</label>
                        <input type="text" name="notel" class="form-control" id="notel" value="{{$profil->notel}}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jawatan" class="form-control" id="jawatan" value="{{$profil->jawatan}}" required>
                    </div>
                  </div>
                  <!-- /.card-body -->
