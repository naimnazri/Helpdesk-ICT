...
<head>
  ...
  <title>HELPDESK ICT | SELESAI RESET</title>
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body text-center">
      <h3 class="login-box-msg">Akaun pengguna telah berdaftar</h3> <br>

        <div class="justify-content-center">
            <a type="button" class="btn btn-primary" href="{{route('login')}}">Log Masuk</a>
            <a type="button" class="btn btn-primary" href="{{url('forgotpassword')}}">Reset Katalaluan</a>
        </div>
