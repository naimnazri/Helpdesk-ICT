                  ...
                  <table id="tableAduan" class="table table-bordered table-hover">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                          ...
                          @endif
                      <td class="text-center"> {{$diff = Carbon\Carbon::parse($adu->tarikh_aduan)->diffInDays()}}</td>
                      <td>
                        <a type="button" title="Jawab Aduan" class="btn btn-block btn-success btn-sm"
                           href="{{ URL::to('t_editaduan/'.$adu->no_aduan)}}">
