      ...
      <div class="row">
        <div class="col-12">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" method="POST" action="{{url('t_store_detail')}}">
                    @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" minlength="9" maxlength="13" name="no_ofis" class="form-control" id="no_ofis" value="{{$pengguna->no_ofis}}" placeholder=" Masukkan No Telefon" required>
                    </div>
                    <div class="form-group">
