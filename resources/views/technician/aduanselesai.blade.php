                ...
                <div class="card-body">
                  ...
                  <table id="tableAduan" class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        @else
                         {{ date('d-m-Y', strtotime($adu->tarikh_aduan))}}</td>
                        @endif
                        </td>
                        <td class="text-center">@if($adu->tarikh_tindakan == '')
                            @else
                        ...
                        <td class="text-center">
                            <?php
                            $dt1 = Carbon\Carbon::parse($adu->tarikh_aduan);
                            $dt2 = Carbon\Carbon::parse($adu->tarikh_tindakan);

                            $days = $dt1->diffInDays($dt2);
                            ?>
                            <div class="text-bold">{{$days}}</div>
                        </td>
                        <td>
